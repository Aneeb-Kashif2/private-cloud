...
const routes: FastifyPluginAsync = async app => {
  app.get("/", { preHandler: app.authenticate }, async request => jsonSafe({ folders: await app.prisma.folder.findMany({ where: { userId: request.user.id }, orderBy: [{ isRoot: "desc" }, { name: "asc" }] }) }));
